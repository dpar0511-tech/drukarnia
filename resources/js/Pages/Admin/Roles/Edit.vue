...
const submit = () => {
  form.put(route('admin.roles.update', props.role.id), {
    onSuccess: () => toast.success('Rola została zaktualizowana.')
  })
}
</script>

<template>
  <AppLayout title="Edytuj rolę">
    <Head title="Edytuj rolę" />
    ...
    <div class="flex flex-col gap-6 p-6">
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col gap-1">
          <h1 class="text-3xl font-bold tracking-tight">Edytuj rolę: {{ role.name }}</h1>
          <p class="text-muted-foreground">
            Zaktualizuj nazwę roli i przypisane do niej uprawnienia.
          </p>
        </div>
      </div>
        ...
        <form @submit.prevent="submit">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Zarządzaj dostępem dla tej roli systemowej.
              </CardDescription>
            </CardHeader>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div class="relative">
                      ...
                      <Input v-model="form.name" class="pl-10" required />
                    </div>
                  </FormControl>
